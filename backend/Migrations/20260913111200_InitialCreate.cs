        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerPasswordHash = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    ...
                    PointsPerAmount = table.Column<int>(type: "int", nullable: false),
                    PointsToMoney = table.Column<decimal>(type: "decimal(12,0)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalSpent = table.Column<decimal>(type: "decimal(15,0)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinOrderAmount = table.Column<decimal>(type: "decimal(12,0)", nullable: false),
                    Scope = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    AssignedCustomerId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vouchers_Customers_AssignedCustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuItemId = table.Column<int>(type: "int", nullable: false),
                    SizeId = table.Column<int>(type: "int", nullable: false),
                    ExtraPrice = table.Column<decimal>(type: "decimal(12,0)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItemSizes", x => x.MenuItemSizeId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MenuItemToppingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MenuItemId = table.Column<int>(type: "int", nullable: false),
                    ToppingId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItemToppings", x => x.MenuItemToppingId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    SubTotal = table.Column<decimal>(type: "decimal(15,0)", nullable: false),
                    DiscountAmount = table.Column<decimal>(type: "decimal(15,0)", nullable: false),
                    PointsUsed = table.Column<int>(type: "int", nullable: false),
                    PointsEarned = table.Column<int>(type: "int", nullable: false),
                    ServiceFee = table.Column<decimal>(type: "decimal(12,0)", nullable: false),
                    TotalAmount = table.Column<decimal>(type: "decimal(15,0)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToppingTotal = table.Column<decimal>(type: "decimal(12,0)", nullable: false),
                    SubTotal = table.Column<decimal>(type: "decimal(12,0)", nullable: false),
                    SugarLevel = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    IceLevel = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VoucherUsages", x => x.UsageId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItemSizes_MenuItemId_SizeId",
                table: "MenuItemSizes",
                columns: new[] { "MenuItemId", "SizeId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItemToppings_MenuItemId_ToppingId",
                table: "MenuItemToppings",
                columns: new[] { "MenuItemId", "ToppingId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MenuItemToppings_ToppingId",
                table: "MenuItemToppings",
                column: "ToppingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_TenantId_OrderCode",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tables_StoreId_TableNumber",
                table: "Tables",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vouchers_AssignedCustomerId",
                table: "Vouchers",
